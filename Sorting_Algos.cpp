...
#include <iostream>
using namespace std;
//This file contains all sorting algorithms and all auxilary fucntions used (ie swap functions and array generation funcsions)
...
int* arrayfill(int size, int number) //returns an array of size size filled with number
{
...
int Getmax(int arr[],int s) //gets maximum value in an array
{
    int max = arr[0];
    for( int i = 1; i <s; i++)
        {
